...
static void test_strings_table_entry_buf_basic() {
    ...
    Nan::Set(pt, Nan::New("ip").ToLocalChecked(), Nan::New("127.12.33.22").ToLocalChecked());          // 2 -> 2
    Nan::Set(pt, Nan::New("host").ToLocalChecked(), Nan::New("myname.mydomain.com").ToLocalChecked()); // 3 -> 1
    Nan::Set(pt, Nan::New("rate").ToLocalChecked(), Nan::New("99").ToLocalChecked());                  // 4 -> 4

    v8::Local<v8::String> attrstr = Nan::New("").ToLocalChecked();
...
static void test_strings_table_entry_buf_repeated() {
    ...
    v8::Local<v8::String> attrstr = Nan::New("").ToLocalChecked();
    v8::Local<v8::Object> pt = Nan::New<v8::Object>();
    Nan::Set(pt, Nan::New("ip").ToLocalChecked(), Nan::New("12.53.14.8").ToLocalChecked());
    Nan::Set(pt, Nan::New("host").ToLocalChecked(), Nan::New("myname.mydomain.com").ToLocalChecked());
    ...
    pt = Nan::New<v8::Object>();
    Nan::Set(pt, Nan::New("ip").ToLocalChecked(), Nan::New("22.33.11.1").ToLocalChecked());
    Nan::Set(pt, Nan::New("host").ToLocalChecked(), Nan::New("myname.mydomain.com").ToLocalChecked());
...
static void test_strings_table_entry_buf_large_seq() {
    ...
    int* error = nullptr;
    for (int i = 0; i < 10; i++) {
        v8::Local<v8::String> tag_suffix = Nan::New(std::to_string(tcount++).c_str()).ToLocalChecked();
        int vcount = 1;

        for (int j = 0; j < 125 + (i % 5); j++) { //1-125, 2-126, 3-127, 4-128, 5-129, 6-125,..
            v8::Local<v8::String> val_suffix = Nan::New(std::to_string(vcount++).c_str()).ToLocalChecked();

            pt = Nan::New<v8::Object>();
            Nan::Set(pt, v8::String::Concat(tbase, tag_suffix), v8::String::Concat(vbase, val_suffix));
    ...
    pt = Nan::New<v8::Object>();
    Nan::Set(pt, Nan::New("mytag5").ToLocalChecked(), Nan::New("myval129").ToLocalChecked());
...
void test_strings_table_wide_point() {
    ...
    Nan::Set(pt, Nan::New("name").ToLocalChecked(), Nan::New("cpu.system").ToLocalChecked());
    Nan::Set(pt, Nan::New("pop").ToLocalChecked(), Nan::New("sf").ToLocalChecked());
    Nan::Set(pt, Nan::New("time2").ToLocalChecked(), Nan::New("Tue May 26 2015 17:25:27 GMT-0700 (PDT)").ToLocalChecked());
    Nan::Set(pt, Nan::New("value2").ToLocalChecked(), Nan::New("120").ToLocalChecked());
    Nan::Set(pt, Nan::New("value3").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("value4").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("host").ToLocalChecked(), Nan::New("foo.com").ToLocalChecked());
    Nan::Set(pt, Nan::New("value5").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("value").ToLocalChecked(), Nan::New("333333").ToLocalChecked());
    Nan::Set(pt, Nan::New("value6").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("value7").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("value8").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("value9").ToLocalChecked(), Nan::New("22123").ToLocalChecked());
    Nan::Set(pt, Nan::New("time").ToLocalChecked(), Nan::New("14044044").ToLocalChecked());
    ...
    v8::String::Utf8Value k(attrstr);
    //attr str should be ordered
    assert(!memcmp(*k,
            "host=foo.com,name=cpu.system,pop=sf,time=14044044,time2=Tue May 26 2015 17:25:27 GMT-0700 (PDT),value=333333,value2=120,value3=22123,value4=22123,value5=22123,value6=22123,value7=22123,value8=22123,value9=22123",
            strlen(*k)));
